...
insert into offer(title, model_id, body_style_id, fuel_type_id, year, mileage, engine_size, engine_power, doors, colour, description, price, user_id,yearofadd) values
(
'Nissan Primera P11.144', 10, 1, 1, 2000, 152000, 1.6, 100, 5, 'wiśniowy',
'Nie sprzedam za nic w świecie, proszę nie dzwonić i nie pytać. Pokazuję zdjęcia, żeby się pochwalić.', 0, 1,20171010),
(
